  ...
  window.DEFAULT_TRIP = {
    ...
    days: [
      day(1, '4.8', 'יום שלישי, 4 באוגוסט', 'טסים למלאגה ומתמקמים', 'נתב״ג ← מלאגה ← Ocean House',
        'יום נסיעה רגוע: טיסה, הגעה מסודרת למלון, קנייה קצרה של מים ומוצרים לבוקר וארוחת ערב ליד הים.',
        [['09:30', 'נפגשים בנתב״ג', 'שתי המשפחות נפגשות בטרמינל 3 ובודקות כבודה יחד.', '🧳'], ['12:35', 'טיסת IZ 261', 'טיסה ישירה למלאגה.', '✈️'], ['17:30', 'נחיתה במלאגה', 'איסוף מזוודות והתארגנות ל־Uber.', '🛬'], ['19:30', 'צ׳ק־אין וערב רגוע', 'התמקמות בשתי הסוויטות.', '🏨'], ['20:15', 'קנייה ראשונה ב־Carrefour Express', 'מים, פירות, נשנושים ומוצרים לבוקר. הסניף ברחוב Carmen 40 פתוח עד 01:00.', '🛒']],
        ['לשמור בגדי החלפה לילדים בתיק היד.', 'לנסוע לקנייה ב־Uber קצר ולהשאיר את המזוודות במלון.', 'לקנות רק ליום־יומיים: בחדר יש מיני־בר וקומקום, לא מטבח מלא.'],
        ['Málaga Airport', 'Ocean House Costa del Sol by Grupotel'], { duration: 'יום טיסה', walking: 'מעט מאוד', places: [{ label: 'Carrefour Express Calle Carmen 40', maps: map('Carrefour Express Calle Carmen 40 Torremolinos') }] }),
