(() => {
  ...
  window.DEFAULT_TRIP = {
    ...
    documents: [
      ...
      { id: 'doc-insurance', title: 'ביטוח נסיעות · הראל', category: 'מסמכים', status: 'מאושר', note: 'ביטוח בריאות נסיעות בהראל, משפחת גנם. מספר פוליסה · 4 ספרות אחרונות: 8026 (המספר המלא נשמר מחוץ לאתר הציבורי). מוקד חירום 24 שעות: טלפון 972-3-7547030, פקס 972-3-7348168, וואטסאפ 972-52-7544589.', href: '' }
    ]
  };
})();
