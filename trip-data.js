(() => {
  ...
  const day = (number, shortDate, date, title, routeText, summary, schedule, tips, navPoints, options = {}) => ({
    ...
    navigation: {
      ...
      legs: navPoints.map(point => ({ label: point, sub: 'פתיחה ב־Waze', app: 'Waze', href: waze(point) }))
    },
  ...
  window.DEFAULT_TRIP = {
    ...
    fullRoute: {
      ...
      stops: [
        { name: 'שדה מלאגה', kind: 'הגעה וחזרה' },
        { name: 'טורמולינוס', kind: 'בסיס לינה' },
        { name: 'בנאלמדנה', kind: 'מרינה ואטרקציות' },
        { name: 'מיחאס', kind: 'עיירה לבנה' },
        { name: 'מרבייה', kind: 'עיר עתיקה וחוף' },
        { name: 'מלאגה', kind: 'עיר, תרבות וקניות' }
      ]
    },
    days: [
      ...
      day(2, '5.8', 'יום רביעי, 5 באוגוסט', 'יום בריכה, ים ומרינה', 'Ocean House ← Puerto Marina',
        ...
        [['09:00', 'בוקר חופשי', 'בריכה, חוף וארוחת בוקר בלי שעון.', '🏖️'], ['13:00', 'מנוחה במלון', 'שעות החום בחדרים.', '😴'], ['17:30', 'Puerto Marina', 'טיול בין הסירות, גלידה וארוחת ערב.', '⛵'], ['21:00', 'חזרה למלון', 'לילה מוקדם אחרי יום הטיסה.', '🌙']],
        ['כובעים, קרם הגנה ומים גם בשעות אחר הצהריים.', 'המרינה נוחה לעגלות ולהליכה משפחתית.', 'אפשר לפצל: מי שעייף נשאר במלון.'],
        ['Ocean House Costa del Sol by Grupotel', 'Puerto Marina Benalmádena'], { duration: 'חצי יום פעיל', walking: 'קלה ומישורית' }),
      ...
      day(3, '6.8', 'יום חמישי, 6 באוגוסט', 'מלאגה העתיקה והנמל', 'טורמולינוס ← מרכז מלאגה ← Muelle Uno',
        ...
        [['09:00', 'יציאה למלאגה', 'עדיף ברכבת הפרברים כדי לחסוך חניה.', '🚆'], ['10:00', 'העיר העתיקה', 'Calle Larios, הקתדרלה וכיכרות מוצלות.', '🏛️'], ['13:00', 'ארוחה ומנוחה', 'עצירה ארוכה באזור הנמל.', '🍽️'], ['17:00', 'Muelle Uno', 'טיילת, חנויות וגלידה מול המים.', '🛍️'], ['20:00', 'חזרה לטורמולינוס', 'ערב חופשי במלון.', '🌅']],
        ['באוגוסט חם מאוד — להשאיר מוזיאון כאפשרות ממוזגת.', 'לא לנסות להספיק את כל האתרים ביום אחד.', 'לצלם מראש את תחנת הרכבת לחזרה.'],
        ['Ocean House Costa del Sol by Grupotel', 'Calle Larios Malaga', 'Muelle Uno Malaga', 'Ocean House Costa del Sol by Grupotel'], { duration: '8–9 שעות', walking: 'בינונית, עם הפסקות' }),
      ...
      day(4, '7.8', 'יום שישי, 7 באוגוסט', 'בנאלמדנה בקצב קל', 'טורמולינוס ← Benalmádena Pueblo',
        ...
        [['09:30', 'Benalmádena Pueblo', 'סמטאות לבנות, כיכר ותצפית.', '🤍'], ['12:00', 'סטופה בודהיסטית או פארק', 'בחירה קצרה לפי מצב הרוח והחום.', '🌿'], ['14:00', 'חזרה למלון', 'מנוחה, בריכה והתארגנות.', '🏨'], ['19:00', 'ערב משפחתי', 'ארוחה מתוכננת מראש וטיול קצר.', '🕯️']],
        ['לקנות מצרכים ושתייה לפני אחר הצהריים.', 'לתאם מראש מקום לארוחת הערב לשמונה אנשים.', 'להימנע מלוח צפוף ביום שישי.'],
        ['Ocean House Costa del Sol by Grupotel', 'Benalmádena Pueblo', 'Ocean House Costa del Sol by Grupotel'], { duration: 'חצי יום', walking: 'קלה, מעט עליות' }),
      ...
      day(6, '9.8', 'יום ראשון, 9 באוגוסט', 'עוברים מלון ונשארים בחוף', 'Ocean House ← Occidental Torremolinos Playa',
        ...
        [['09:00', 'אריזה וארוחת בוקר', 'בודקים את שני החדרים לפני היציאה.', '🧳'], ['11:00', 'צ׳ק־אאוט', 'יציאה לפני 12:00 והעברה למלון הבא.', '🚐'], ['12:00', 'השארת מזוודות', 'אם החדרים אינם מוכנים, משאירים בקבלה.', '🛎️'], ['14:00', 'צ׳ק־אין', 'חלוקת שני חדרי המשפחה והתארגנות.', '🏨'], ['16:00', 'בריכה וחוף', 'שאר היום חופשי.', '🏖️']],
        ['לתאם רכב גדול או שתי מוניות מראש.', 'לסמן כל מזוודה בשם המשפחה והחדר.', 'האישור למלון השני אינו ניתן להחזר.'],
        ['Ocean House Costa del Sol by Grupotel', 'Occidental Torremolinos Playa'], { duration: 'יום מעבר קל', walking: 'מעט מאוד' }),
      ...
      day(10, '13.8', 'יום חמישי, 13 באוגוסט', 'יום אחרון חופשי', 'Occidental והחוף',
        'יום גמיש לסגירת מעגל: בריכה, חוף, קניות אחרונות ואריזה מסודרת לפני הטיסה.',
        [['09:00', 'בוקר חופשי', 'כל משפחה בוחרת ים או בריכה.', '🏖️'], ['13:00', 'מנוחה', 'שעות חום בחדרים.', '😴'], ['17:00', 'קניות אחרונות', 'מזכרות, נשנושים וסידור תיקי יד.', '🛍️'], ['20:00', 'ארוחת סיום', 'ערב משותף ואריזה סופית.', '🎉']],
        ['לשקול את המזוודות לפני השינה.', 'להכין בגדי טיסה ותיקי יד בנפרד.', 'לאשר את ההסעה לשדה למחר.'],
        ['Occidental Torremolinos Playa'], { duration: 'יום חופשי', walking: 'לבחירה', badge: 'גמיש' }),
